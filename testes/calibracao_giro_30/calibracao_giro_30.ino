// Calibracao isolada dos passos do radar.
...
const unsigned int TEMPO_ESQUERDA_MS = 270;
const unsigned int TEMPO_DIREITA_MS = 289;
...
void setup() {
  ...
  pararMotores();
  Serial.println(F("=== CALIBRACAO DOS PASSOS DO RADAR ==="));
...
void executarPasso(bool esquerda) {
  Serial.println(esquerda ? F("Passo à ESQUERDA")
                           : F("Passo à DIREITA"));
